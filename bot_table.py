...
print("📌 Прогноз ранга по задержке", flush=True)
...
MIN_CONFIDENCE = 28.0  # Минимальная уверенность
...
LEARNED_FILE = STATE_DIR / "learned_ranks.json"
